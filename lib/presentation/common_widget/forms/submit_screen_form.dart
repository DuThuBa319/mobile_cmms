...
class SubmitScreenForm extends StatefulWidget {
  ...
  @override
  _SubmitScreenFormState createState() => _SubmitScreenFormState();
}

class _SubmitScreenFormState extends State<SubmitScreenForm>
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.bgHeader),
          fit: BoxFit.cover,
        ),
      ),
      child: Row(
